...
describe('diff-arrays-objects-strings', function () {
    ...
    it('two of each no update', function () {
        const first = [
        ...
        const second = [
            '5d416a0e063cbf4ac130b3ba',
            '5d416a0e063cbf4ac130b3bb',
            '52416a0e063cbf4ac130b3bc',
            '52416a0e063cbf4ac130b3bd'];
        const results = diff(first, second, 'id');
        should(results.added).be.eql(['52416a0e063cbf4ac130b3bc', '52416a0e063cbf4ac130b3bd']);
        should(results.removed).be.eql(['5d416a0e063cbf4ac130b3bc', '5d416a0e063cbf4ac130b3bd']);
        should(results.same).be.eql(['5d416a0e063cbf4ac130b3ba', '5d416a0e063cbf4ac130b3bb']);
    });
